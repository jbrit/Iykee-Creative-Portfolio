      ...
      <div class="container h-100 d-flex flex-column">
        ...
        <div style="flex-grow: 1" class="row py-5">
          ...
          >
            ...
            <div class="f-18 mb-5 fw-325">
              I am a creative with experience in cooperate and interface design.
              My collaborative skills has been demonstrated through successful
              completion of projects
            </div>
            <div class="icons-holder">
              <BaseLink href="#" class="icon"
                ><span
                  class="iconify"
              ...
              ><BaseLink href="#" class="icon"
                ><span
                  class="iconify"
                  data-icon="whh:behance"
                  data-inline="false"
                ></span> </BaseLink
              ><BaseLink href="#" class="icon"
                ><span
                  class="iconify"
                  data-icon="whh:linkedin"
                  data-inline="false"
                ></span> </BaseLink
              ><BaseLink href="#" class="icon"
                ><span
                  class="iconify"
                  data-icon="whh:twitter"
                  data-inline="false"
                ></span>
              </BaseLink>
            </div>
